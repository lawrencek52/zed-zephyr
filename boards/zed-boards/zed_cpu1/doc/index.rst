...
The ``zed_cpu1/nrf5340/cpuapp`` build target provides support for the application
core on the nRF5340 SoC. The ``zed_cpu1/nrf5340/cpunet`` build target provides
...
Applications built for the ``zed_cpu1/nrf5340/cpuapp`` board by default
...
1. Build the Non-Secure Zephyr application
   for the application core using ``-DBOARD=zed_cpu1/nrf5340/cpuapp/ns``.
...
2. Build the application firmware for the network core using
   ``-DBOARD=zed_cpu1/nrf5340/cpunet``.
...
1. Build the Secure Zephyr application for the application core
   using ``-DBOARD=zed_cpu1/nrf5340/cpuapp`` and
...
2. Build the Non-Secure Zephyr application for the application core
   using ``-DBOARD=zed_cpu1/nrf5340/cpuapp/ns``.
...
and :ref:`application_run`), using ``-DBOARD=zed_cpu1/nrf5340/cpuapp`` for
the firmware running on the nRF5340 application core, and using
``-DBOARD=zed_cpu1/nrf5340/cpunet`` for the firmware running
...
:zephyr_file:`boards/nordic/zed_cpu1/nrf5340_cpuapp_common.dtsi`.
